  ...
  <div class="container">
    ...
    <?php else : ?>
        ...
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:24px">
          <a href="<?php echo esc_url(home_url('/obra-publica/programa-anual/')); ?>" style="text-decoration:none;background:var(--blanco);border-radius:12px;box-shadow:var(--sombra);padding:32px 24px;text-align:center;border-top:4px solid var(--rojo-pri);display:block">
          ...
          <a href="<?php echo esc_url(home_url('/obra-publica/avances/')); ?>" style="text-decoration:none;background:var(--blanco);border-radius:12px;box-shadow:var(--sombra);padding:32px 24px;text-align:center;border-top:4px solid var(--verde-mexico);display:block">
          ...
          <a href="<?php echo esc_url(home_url('/obra-publica/contratos/')); ?>" style="text-decoration:none;background:var(--blanco);border-radius:12px;box-shadow:var(--sombra);padding:32px 24px;text-align:center;border-top:4px solid #1565C0;display:block">
