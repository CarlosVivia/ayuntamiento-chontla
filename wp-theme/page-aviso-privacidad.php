  ...
  <div class="container" style="max-width:820px;margin:0 auto">
    ...
    <?php else : ?>
      <div style="background:var(--blanco);border-radius:12px;box-shadow:var(--sombra);padding:40px 48px;font-size:14px;line-height:1.8;color:var(--negro-suave)">
        ...
        <ul style="margin:10px 0 10px 22px"><li>Nombre completo y apellidos</li><li>Domicilio, municipio, estado y código postal</li><li>Número de teléfono fijo y/o celular</li><li>Correo electrónico</li><li>Clave Única de Registro de Población (CURP)</li><li>Registro Federal de Contribuyentes (RFC)</li><li>Datos de identificación oficial</li></ul>
        ...
        <ul style="margin:10px 0 10px 22px"><li>Prestación de trámites y servicios municipales</li><li>Atención de solicitudes, quejas y sugerencias</li><li>Expedición de actas, licencias y constancias</li><li>Registro y seguimiento de obras y programas sociales</li><li>Cumplimiento de obligaciones legales y fiscales</li></ul>
        ...
        <p>Sus datos podrán ser transferidos a autoridades federales, estatales o municipales cuando sea necesario para el cumplimiento de obligaciones legales, sin requerir su consentimiento en términos del artículo 37 de la LFPDPPP.</p>
        ...
        <p>Usted tiene derecho a <strong>Acceder, Rectificar, Cancelar u Oponerse</strong> al tratamiento de sus datos personales. Para ejercerlos, contacte al Departamento de Transparencia o escriba a <?php echo esc_html(chontla_get('municipio_email','presidencia@chontla.gob.mx')); ?>.</p>
        <h2 style="font-size:17px;font-weight:700;color:var(--rojo-pri);margin:28px 0 10px;padding-bottom:6px;border-bottom:2px solid #eee">6. Cambios al Aviso</h2>
        <p>Toda modificación será publicada oportunamente en esta página oficial del Ayuntamiento de Chontla.</p>
        <div style="background:#FAFAFA;border-radius:8px;padding:16px 20px;margin-top:30px;font-size:12.5px;color:var(--gris-texto);text-align:center"><i class="fas fa-shield-alt" style="color:var(--rojo-pri);margin-right:6px"></i>H. Ayuntamiento de Chontla, Veracruz · Aviso de Privacidad vigente</div>
      </div>
